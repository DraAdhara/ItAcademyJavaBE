...
SELECT nombre, precio AS 'precio_euros', (SELECT precio * 1.10) AS 'precio_dolares' FROM producto;
...
SELECT nombre AS 'nom de producto', precio AS euros, (SELECT precio * 1.10) AS dolars FROM producto;
...
SELECT producto.nombre, precio, fabricante.nombre FROM producto, fabricante WHERE codigo_fabricante = fabricante.codigo ORDER BY precio ASC LIMIT 1;
#25. Retorna el nom del producte, el seu preu i el nom del seu fabricant, del producte més car.
SELECT producto.nombre, precio, fabricante.nombre FROM producto, fabricante WHERE codigo_fabricante = fabricante.codigo ORDER BY precio DESC LIMIT 1;
...
SELECT producto.nombre, producto.precio, fabricante.nombre FROM producto, fabricante WHERE fabricante.nombre = "Lenovo" AND precio = (SELECT MAX(precio) FROM producto) ;
